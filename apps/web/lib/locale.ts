...
export const meta: Record<Locale, { title: string; description: string }> = {
  en: {
    title: "OnlineJourno Newsroom — editorial intelligence for journalists",
    description:
      "The OnlineJourno Newsroom: source monitoring, framing analysis, and AI-assisted briefs for newsrooms — journalist-first, configurable per newsroom.",
  },
  hi: {
