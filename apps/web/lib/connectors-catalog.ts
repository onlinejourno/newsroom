...
export const CONNECTOR_CATALOG: CategoryDef[] = [
  {
    ...
    providers: [
      ...
      { key: "joomla", label: "Joomla (OSS)", modes: ["api"], oss: true, fields: [{ name: "base_url", label: "Site URL" }, SECRET_REF] },
      { key: "typo3", label: "TYPO3 (OSS)", modes: ["api"], oss: true, fields: [{ name: "base_url", label: "Site URL" }, SECRET_REF] },
