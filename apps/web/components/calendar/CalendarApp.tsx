...
// display, IOJ green system accent, red urgency accent for past-due.
//
...
function PastDueView({ events, beats, todayISO, onSelect }: ViewProps) {
  ...
  return (
    <div>
      <div style={{ background: "#fdeaea", border: `1px solid ${C.urgent}`, padding: "14px 20px", marginBottom: 20, display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
      ...
      <aside style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: 520, maxWidth: "90vw", background: "#fff", borderLeft: `1px solid ${C.ink}`, zIndex: 51, overflowY: "auto", boxShadow: "-10px 0 30px rgba(17,17,17,0.15)" }}>
        ...
        <div style={{ padding: "24px 28px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
            <BeatTag beats={beats} beat={event.beat} />
            <div style={{ fontFamily: UI, fontSize: 10, fontWeight: 800, letterSpacing: ".12em", textTransform: "uppercase", color: isPast ? C.urgent : bucket.color, padding: "3px 8px", background: isPast ? "#fdeaea" : bucket.strip, border: `1px solid ${isPast ? C.urgent : bucket.color}` }}>
          ...
          {isPast && (
            <div style={{ marginBottom: 18, padding: "12px 14px", background: "#fdeaea", border: `1px solid ${C.urgent}` }}>
