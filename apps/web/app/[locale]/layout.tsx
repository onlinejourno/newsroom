...
export async function generateMetadata({
  ...
  return {
    metadataBase: new URL("https://app.onlinejourno.com"),
    title,
    description,
    alternates: { canonical: `/${loc}` },
    openGraph: {
      type: "website",
      siteName: "OnlineJourno Newsroom",
      url: `/${loc}`,
      title,
      description,
    },
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@graph": [
                {
                  "@type": "Organization",
                  "@id": "https://app.onlinejourno.com/#org",
                  name: "OnlineJourno",
                  url: "https://onlinejourno.com",
                  description: "A journalist-first suite of editorial-intelligence tools for newsrooms.",
                },
                {
                  ...
                  operatingSystem: "Web",
                  url: "https://app.onlinejourno.com",
                  publisher: { "@id": "https://app.onlinejourno.com/#org" },
                  description:
                    "Source monitoring, framing analysis, and AI-assisted briefs for newsrooms — journalist-first, configurable per newsroom.",
                },
              ],
            }),
          }}
