...
The following materials in this repository are licensed under the
**Creative Commons Attribution 4.0 International License (CC BY 4.0)**:

- Scoring methodology documentation (`docs/methodology/`, `docs/adr/`)
- SKOS ontologies and vocabulary files (`ontology/`, `*.skos.ttl`, `*.skos.json`)
...
**Attribution:** Subhash Rai (OnlineJourno) · https://onlinejourno.com
